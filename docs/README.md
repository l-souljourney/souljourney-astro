...
`v2.3.4` 起，`docs/` 目录按“活跃公开 / 历史归档”分层管理，并明确控制公开深度。当前执行主线以 `v2.4.0` 商业化路线图为准，`v2.x` 路线图保留为历史技术底座。

## 活跃文档

- [Astro 商业化双语内容平台路线图（当前执行主线）](./plans/2026-05-04-astro-commercial-roadmap.md)
...
- `v2.x 路线图（历史技术底座）`：历史技术路线参考，当前执行主线已切换到 `Astro 商业化双语内容平台路线图`

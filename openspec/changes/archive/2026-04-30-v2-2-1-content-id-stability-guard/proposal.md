...
状态（2026-04-09）：该 change 已作为 `v2.2.1` 事故修复版本落地于 `main`，并补齐了测试与 RCA 文档。
...
- 不在本次变更中推进路由/模板/查询收敛（该工作另行归入 `v2-2-1-routing-template-query-consolidation` 规划项）
...
- **受影响代码**: `src/content.config.ts`, `.github/workflows/deploy.yml`, `tests/*`, `script/*`
